...
#GO2
list_L=["all","L0","L1","L2","L3"]
list_Ld=[-20.0,-20.0,-0.25,3.25,6.75]
list_Lu=[20.0,-0.25,3.25,6.75,20.0]
...
WA_revPBED3=np.zeros((1,8))
for f in list_filename:
    filename = (f+'_IS_water_angle.'+ext)
    if (os.path.isfile(filename)):
        WA_revPBED3 = np.append(WA_revPBED3, np.genfromtxt(filename,dtype='float64',skip_header=1,usecols=(1,2,3,4,5,6,8,10)), axis=0)
...
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,6])
    ,hist=False,bins=bin_0_180_01,kde_kws={'clip': (-1,1) , "linestyle":"-","linewidth":"3.0","color":"blue"}, label=r'$L0$')
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,6])
    ,hist=False,bins=bin_0_180_01,kde_kws={'clip': (-1,1) , "linestyle":"-","linewidth":"3.0","color":"gold"}, label=r'$L1$')
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,6])
    ,hist=False,bins=bin_0_180_01,kde_kws={'clip': (-1,1) , "linestyle":"--","linewidth":"3.0","color":"red"}, label=r'$L2$')
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[4]) & (WA_revPBED3[:,5]<=list_Lu[4])][:,6])
...
plt.savefig('figure_cos_DW_L_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
plt.rcParams["figure.figsize"] = [14,7]
fig1, ax1 = plt.subplots(dpi=300)
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,7])
    ,hist=False,bins=bin_90_180_01,kde_kws={'clip': (-1,0) , "linestyle":"-","linewidth":"3.0","color":"blue"}, label=r'$L0$')
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,7])
    ,hist=False,bins=bin_90_180_01,kde_kws={'clip': (-1,0) , "linestyle":"-","linewidth":"3.0","color":"gold"}, label=r'$L1$')
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,7])
    ,hist=False,bins=bin_90_180_01,kde_kws={'clip': (-1,0) , "linestyle":"--","linewidth":"3.0","color":"red"}, label=r'$L2$')
sns.distplot(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[4]) & (WA_revPBED3[:,5]<=list_Lu[4])][:,7])
...
plt.savefig('figure_cos_HH_L_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
ax1 = plt.subplot(211)
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,6])
    ,hist=False,bins=180,kde_kws={'clip': (0,180) , "linestyle":"-","linewidth":"3.0","color":"blue"}, label=r'$L0$')
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,6])
    ,hist=False,bins=180,kde_kws={'clip': (0,180) , "linestyle":"-","linewidth":"3.0","color":"gold"}, label=r'$L1$')
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,6])
    ,hist=False,bins=180,kde_kws={'clip': (0,180) , "linestyle":"--","linewidth":"3.0","color":"red"}, label=r'$L2$')
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[4]) & (WA_revPBED3[:,5]<=list_Lu[4])][:,6])
...
ax2 = plt.subplot(212)
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,7])
    ,hist=False,bins=90,kde_kws={'clip': (90,180) , "linestyle":"-","linewidth":"3.0","color":"blue"}, label=r'$L0$')
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,7])
    ,hist=False,bins=90,kde_kws={'clip': (90,180) , "linestyle":"-","linewidth":"3.0","color":"gold"}, label=r'$L1$')
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,7])
    ,hist=False,bins=90,kde_kws={'clip': (90,180) , "linestyle":"--","linewidth":"3.0","color":"red"}, label=r'$L2$')
sns.distplot(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[4]) & (WA_revPBED3[:,5]<=list_Lu[4])][:,7])
...
plt.savefig('figure_DW_HH_L_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
plt.savefig('figure_cos_DW_HH_L_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
ax1 = plt.subplot(221)
plt.hist2d(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[0]) & (WA_revPBED3[:,5]<=list_Lu[0])][:,6]),
    np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[0]) & (WA_revPBED3[:,5]<=list_Lu[0])][:,7]),
...
ax2 = plt.subplot(222)
plt.hist2d(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,6]),
    np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb2 = plt.colorbar()
...
ax2.axes.set_ylabel(r'P(θ$_{HH}$)',{'fontsize':25,'fontweight':'normal'})
ax2.text(0.02, 0.92, "(revPBE-D3-L1)", transform=ax2.transAxes, fontsize=14, fontweight='bold')


ax3 = plt.subplot(223)
plt.hist2d(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,6]),
    np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb3 = plt.colorbar()
...
ax3.text(0.02, 0.92, "(revPBE-D3-L2)", transform=ax3.transAxes, fontsize=14, fontweight='bold')

ax4 = plt.subplot(224)
plt.hist2d(np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,6]),
    np.degrees(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb4 = plt.colorbar()
...
ax4.text(0.02, 0.92, "(revPBE-D3-L3)", transform=ax4.transAxes, fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('figure_DW-HH_L_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
ax1 = plt.subplot(221)
plt.hist2d(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[0]) & (WA_revPBED3[:,5]<=list_Lu[0])][:,6]),
    np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[0]) & (WA_revPBED3[:,5]<=list_Lu[0])][:,7]),
...
ax2 = plt.subplot(222)
plt.hist2d(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,6]),
    np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[1]) & (WA_revPBED3[:,5]<=list_Lu[1])][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
cb2 = plt.colorbar()
cb2.set_label("Occurences",size=20)
cb2.outline.set_linewidth(4)
...
ax3 = plt.subplot(223)
plt.hist2d(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,6]),
    np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[2]) & (WA_revPBED3[:,5]<=list_Lu[2])][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
cb3 = plt.colorbar()
cb3.set_label("Occurences",size=20)
cb3.outline.set_linewidth(4)
...
ax4 = plt.subplot(224)
plt.hist2d(np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,6]),
    np.cos(WA_revPBED3[(WA_revPBED3[:,5]>list_Ld[3]) & (WA_revPBED3[:,5]<=list_Lu[3])][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
cb4 = plt.colorbar()
cb4.set_label("Occurences",size=20)
cb4.outline.set_linewidth(4)
...
plt.tight_layout()
plt.savefig('figure_cos_DW-HH_L_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
plt.savefig('figure_cos_DW_T_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
plt.rcParams["figure.figsize"] = [14,7]
fig1, ax1 = plt.subplots(dpi=300)
sns.distplot(np.cos(WA_revPBED3[( ( (WA_revPBED3[:,0] == 1) | (WA_revPBED3[:,1] == 1) | (WA_revPBED3[:,2] == 1) ) & (WA_revPBED3[:,3] == 1) )][:,7])
    ,hist=False,bins=bin_90_180_01,kde_kws={'clip': (-1,0) , "linestyle":"-","linewidth":"3.0","color":"gold"}, label=r'$gol$')
sns.distplot(np.cos(WA_revPBED3[( ( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) ) & (WA_revPBED3[:,3] == 1) )][:,7])
    ,hist=False,bins=bin_90_180_01,kde_kws={'clip': (-1,0) , "linestyle":"--","linewidth":"3.0","color":"red"}, label=r'$gl$')
sns.distplot(np.cos(WA_revPBED3[( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) & (WA_revPBED3[:,3] == 0) & (WA_revPBED3[:,4] == 1) )][:,7])
...
plt.savefig('figure_cos_HH_T_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
ax2 = plt.subplot(212)
sns.distplot(np.degrees(WA_revPBED3[( ( (WA_revPBED3[:,0] == 1) | (WA_revPBED3[:,1] == 1) | (WA_revPBED3[:,2] == 1) ) & (WA_revPBED3[:,3] == 1) )][:,7])
    ,hist=False,bins=90,kde_kws={'clip': (90,180) , "linestyle":"-","linewidth":"3.0","color":"gold"}, label=r'$gol$')
sns.distplot(np.degrees(WA_revPBED3[( ( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) ) & (WA_revPBED3[:,3] == 1) )][:,7])
    ,hist=False,bins=90,kde_kws={'clip': (90,180) , "linestyle":"--","linewidth":"3.0","color":"red"}, label=r'$gl$')
sns.distplot(np.degrees(WA_revPBED3[( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) & (WA_revPBED3[:,3] == 0) & (WA_revPBED3[:,4] == 1) )][:,7])
...
plt.savefig('figure_DW_HH_T_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
plt.savefig('figure_cos_DW_HH_T_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
ax1 = plt.subplot(221)
plt.hist2d(np.degrees(WA_revPBED3[(WA_revPBED3[:,4] == 1)][:,6]),
    np.degrees(WA_revPBED3[(WA_revPBED3[:,4] == 1)][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb1 = plt.colorbar()
cb1.set_label("Occurences",size=20)
cb1.outline.set_linewidth(4)
...
ax2 = plt.subplot(222)
plt.hist2d(np.degrees(WA_revPBED3[( ( (WA_revPBED3[:,0] == 1) | (WA_revPBED3[:,1] == 1) | (WA_revPBED3[:,2] == 1) ) & (WA_revPBED3[:,3] == 1) )][:,6]),
    np.degrees(WA_revPBED3[( ( (WA_revPBED3[:,0] == 1) | (WA_revPBED3[:,1] == 1) | (WA_revPBED3[:,2] == 1) ) & (WA_revPBED3[:,3] == 1) )][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb2 = plt.colorbar()
cb2.set_label("Occurences",size=20)
cb2.outline.set_linewidth(4)
...
ax3 = plt.subplot(223)
plt.hist2d(np.degrees(WA_revPBED3[( ( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) ) & (WA_revPBED3[:,3] == 1) )][:,6]),
    np.degrees(WA_revPBED3[( ( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) ) & (WA_revPBED3[:,3] == 1) )][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb3 = plt.colorbar()
cb3.set_label("Occurences",size=20)
cb3.outline.set_linewidth(4)
...
ax4 = plt.subplot(224)
plt.hist2d(np.degrees(WA_revPBED3[( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) & (WA_revPBED3[:,3] == 0) & (WA_revPBED3[:,4] == 1) )][:,6]),
    np.degrees(WA_revPBED3[( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) & (WA_revPBED3[:,3] == 0) & (WA_revPBED3[:,4] == 1) )][:,7]),
    range=((0,180),(90,180)),bins=[36,18],cmap="Blues")
cb4 = plt.colorbar()
cb4.set_label("Occurences",size=20)
cb4.outline.set_linewidth(4)
...
plt.tight_layout()
plt.savefig('figure_DW-HH_T_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
...
ax1 = plt.subplot(221)
plt.hist2d(np.cos(WA_revPBED3[(WA_revPBED3[:,4] == 1)][:,6]),
    np.cos(WA_revPBED3[(WA_revPBED3[:,4] == 1)][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
...
ax2 = plt.subplot(222)
plt.hist2d(np.cos(WA_revPBED3[( ( (WA_revPBED3[:,0] == 1) | (WA_revPBED3[:,1] == 1) | (WA_revPBED3[:,2] == 1) ) & (WA_revPBED3[:,3] == 1) )][:,6]),
    np.cos(WA_revPBED3[( ( (WA_revPBED3[:,0] == 1) | (WA_revPBED3[:,1] == 1) | (WA_revPBED3[:,2] == 1) ) & (WA_revPBED3[:,3] == 1) )][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
cb2 = plt.colorbar()
cb2.set_label("Occurences",size=20)
cb2.outline.set_linewidth(4)
...
ax3 = plt.subplot(223)
plt.hist2d(np.cos(WA_revPBED3[( ( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) ) & (WA_revPBED3[:,3] == 1) )][:,6]),
    np.cos(WA_revPBED3[( ( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) ) & (WA_revPBED3[:,3] == 1) )][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
cb3 = plt.colorbar()
cb3.set_label("Occurences",size=20)
cb3.outline.set_linewidth(4)
...
ax4 = plt.subplot(224)
plt.hist2d(np.cos(WA_revPBED3[( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) & (WA_revPBED3[:,3] == 0) & (WA_revPBED3[:,4] == 1) )][:,6]),
    np.cos(WA_revPBED3[( (WA_revPBED3[:,0] == 0) & (WA_revPBED3[:,1] == 0) & (WA_revPBED3[:,2] == 0) & (WA_revPBED3[:,3] == 0) & (WA_revPBED3[:,4] == 1) )][:,7]),
    range=((-1,1),(-1,0)),bins=[bin_0_180,bin_90_180],cmap="Blues")
cb4 = plt.colorbar()
cb4.set_label("Occurences",size=20)
cb4.outline.set_linewidth(4)
...
plt.tight_layout()
plt.savefig('figure_cos_DW-HH_T_revPBED3', bbox_inches='tight', transparent = True, dpi = 300)
plt.clf()
plt.cla()
plt.close()
