...
DO s = 1, nb_step
    ...
    avg_z(s) = avg_z(s) / o
    D1:DO i = 1, nb_atm
        atm_mat(7,i,s) = avg_z(s)
        IF (atm_mat(2,i,s) .EQ. fluct_center_atmnb) THEN
            atm_mat(8,i,s) = atm_mat(6,i,s) - avg_z(s)
        END IF
    END DO D1
END DO
!$OMP END PARALLEL DO
...
WRITE(41, '(A10,A10,A24,A24)') "Step", "id", "avg_z", "z_fluct"
DO s = 1, nb_step
    DO i = 1, nb_atm
        IF (atm_mat(2,i,s) .EQ. fluct_center_atmnb) THEN
            WRITE(41, '(I10,I10,E24.14,E24.14)') s, INT(atm_mat(1,i,s))&
            , atm_mat(7,i,s), atm_mat(8,i,s)
        END IF
    END DO
END DO
CLOSE(UNIT=41)
