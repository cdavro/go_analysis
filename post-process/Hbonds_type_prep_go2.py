...
hbonds_revPBED3_go2 = np.load('go2_HB_TD_inline_mod10.npz')['ar1']

print("Load go2_HB_TD_inline_mod10.npz Timings: ", timedelta(seconds=timer()-start))
...
#----------------------------------------------------------------------------------------------
start = timer()
np.savez_compressed('go2_HB_TDATSIS_mod10.npz', ar1=BIGONE)

print("Write go2_HB_TDATSIS_mod10.npz Timings: ", timedelta(seconds=timer()-start))
