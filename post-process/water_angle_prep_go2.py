...
WA_AS_revPBED3_go2=np.zeros((1,11))
...
np.savez_compressed('WA_AS_revPBED3_go2.npz', ar1=WA_AS_revPBED3_go2)

print("Write_npz  AS: ",datetime.now())
print("Timings: ", time.time()-start)

#----------------------------------------------------------------------------------------------
del(WA_AS_revPBED3_go2)
...
WA_IS_revPBED3_go2=np.zeros((1,11))
for f in list_filename:
...
np.savez_compressed('WA_IS_revPBED3_go2.npz', ar1=WA_IS_revPBED3_go2)
